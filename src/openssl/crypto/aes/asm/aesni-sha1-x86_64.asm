...
$L$prologue_avx::
	...
	vmovups	xmm13,XMMWORD PTR[((-112))+r15]
	vmovups	xmm14,XMMWORD PTR[((16-112))+r15]
	jmp	$L$oop_avx
ALIGN	16
$L$oop_avx::
	add	ebp,DWORD PTR[rsp]
	vmovups	xmm12,XMMWORD PTR[r12]
	...
	and	edi,eax
	xor	eax,ebx
	vmovdqa	xmm8,XMMWORD PTR[16+r11]
	xor	edi,ebx
	add	ecx,edx
	shrd	ebp,ebp,7
	add	ecx,edi
...
$L$vaesenclast1::
	...
	xor	esi,ecx
	vmovups	xmm12,XMMWORD PTR[16+r12]
	vxorps	xmm12,xmm12,xmm13
	vmovups	XMMWORD PTR[r12*1+r13],xmm11
	vxorps	xmm11,xmm11,xmm12
	vaesenc	xmm11,xmm11,xmm14
	vmovups	xmm15,XMMWORD PTR[((-80))+r15]
	add	edx,ebp
...
$L$vaesenclast2::
	...
	vpxor	xmm6,xmm6,xmm2
	mov	edi,ecx
	vmovups	xmm12,XMMWORD PTR[32+r12]
	vxorps	xmm12,xmm12,xmm13
	vmovups	XMMWORD PTR[16+r12*1+r13],xmm11
	vxorps	xmm11,xmm11,xmm12
	vaesenc	xmm11,xmm11,xmm14
	vmovups	xmm15,XMMWORD PTR[((-80))+r15]
	xor	ecx,edx
	...
	and	esi,edx
	shrd	ecx,ecx,7
	vmovdqa	xmm9,XMMWORD PTR[48+r11]
...
$L$vaesenclast3::
	...
	shld	ebp,ebp,5
	vmovups	xmm12,XMMWORD PTR[48+r12]
	vxorps	xmm12,xmm12,xmm13
	vmovups	XMMWORD PTR[32+r12*1+r13],xmm11
	vxorps	xmm11,xmm11,xmm12
	vaesenc	xmm11,xmm11,xmm14
	vmovups	xmm15,XMMWORD PTR[((-80))+r15]
	add	edx,esi
...
$L$vaesenclast4::
	...
	shrd	ecx,ecx,7
	add	eax,edi
	vmovups	XMMWORD PTR[48+r12*1+r13],xmm11
	lea	r12,QWORD PTR[64+r12]
