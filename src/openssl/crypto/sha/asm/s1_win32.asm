...
$L000loop:
	...
	xor	esi,		edx
	ror	ebx,		2
	lea	ebp,		DWORD PTR 1518500249[edi+ebp]
	add	ebp,		esi
	; 00_15 1
	mov	edi,		ebx
	mov	esi,		ebp
	...
	xor	edi,		ecx
	ror	eax,		2
	lea	ebp,		DWORD PTR 1518500249[edx+ebp]
	add	ebp,		edi
	; 00_15 2
	mov	edx,		eax
	mov	edi,		ebp
	...
	xor	edx,		ebx
	ror	esi,		2
	lea	ebp,		DWORD PTR 1518500249[ecx+ebp]
	add	ebp,		edx
	; 00_15 3
	mov	ecx,		esi
	mov	edx,		ebp
	...
	xor	ecx,		eax
	ror	edi,		2
	lea	ebp,		DWORD PTR 1518500249[ebx+ebp]
	add	ebp,		ecx
	; 00_15 4
	mov	ebx,		edi
	mov	ecx,		ebp
	...
	xor	ebx,		esi
	ror	edx,		2
	lea	ebp,		DWORD PTR 1518500249[eax+ebp]
	add	ebp,		ebx
	; 00_15 5
	mov	eax,		edx
	mov	ebx,		ebp
	...
	xor	eax,		edi
	ror	ecx,		2
	lea	ebp,		DWORD PTR 1518500249[esi+ebp]
	add	ebp,		eax
	; 00_15 6
	mov	esi,		ecx
	mov	eax,		ebp
	...
	lea	ebx,		DWORD PTR 1518500249[eax+ebx]
	mov	eax,		ecx
	rol	eax,		5
	add	ebx,		ebp
	add	ebx,		eax
	...
	lea	eax,		DWORD PTR 1518500249[esi+eax]
	mov	esi,		ebx
	rol	esi,		5
	add	eax,		ebp
	add	eax,		esi
	...
	lea	esi,		DWORD PTR 1518500249[edi+esi]
	mov	edi,		eax
	rol	edi,		5
	add	esi,		ebp
	add	esi,		edi
	...
	lea	edi,		DWORD PTR 1518500249[edx+edi]
	mov	edx,		esi
	rol	edx,		5
	add	edi,		ebp
	add	edi,		edx
	...
	mov	ecx,		edi
	rol	ecx,		5
	lea	edx,		DWORD PTR 1859775393[ebp+edx]
	add	edx,		ecx
	; 20_39 21
	mov	ebp,		edi
	...
	mov	ebx,		edx
	rol	ebx,		5
	lea	ecx,		DWORD PTR 1859775393[ebp+ecx]
	add	ecx,		ebx
	; 20_39 22
	mov	ebp,		edx
	...
	mov	eax,		ecx
	rol	eax,		5
	lea	ebx,		DWORD PTR 1859775393[ebp+ebx]
	add	ebx,		eax
	; 20_39 23
	mov	ebp,		ecx
	mov	eax,		DWORD PTR 28[esp]
	...
	mov	esi,		ebx
	rol	esi,		5
	lea	eax,		DWORD PTR 1859775393[ebp+eax]
	add	eax,		esi
	; 20_39 24
	mov	ebp,		ebx
	...
	mov	edi,		eax
	rol	edi,		5
	lea	esi,		DWORD PTR 1859775393[ebp+esi]
	add	esi,		edi
	; 20_39 25
	mov	ebp,		eax
	...
	mov	edx,		esi
	rol	edx,		5
	lea	edi,		DWORD PTR 1859775393[ebp+edi]
	add	edi,		edx
	; 20_39 26
	mov	ebp,		esi
	...
	and	ebp,		esi
	lea	ebx,		DWORD PTR 2400959708[eax+ebx]
	mov	eax,		edx
	ror	edx,		2
	and	eax,		edi
	or	ebp,		eax
	...
	and	ebp,		edi
	lea	eax,		DWORD PTR 2400959708[esi+eax]
	mov	esi,		ecx
	ror	ecx,		2
	and	esi,		edx
	or	ebp,		esi
	...
	and	ebp,		edx
	lea	esi,		DWORD PTR 2400959708[edi+esi]
	mov	edi,		ebx
	ror	ebx,		2
	and	edi,		ecx
	or	ebp,		edi
	...
	and	ebp,		ebx
	lea	edx,		DWORD PTR 2400959708[ecx+edx]
	mov	ecx,		esi
	ror	esi,		2
	and	ecx,		eax
	or	ebp,		ecx
	...
	and	ebp,		eax
	lea	ecx,		DWORD PTR 2400959708[ebx+ecx]
	mov	ebx,		edi
	ror	edi,		2
	and	ebx,		esi
	or	ebp,		ebx
	...
	mov	edi,		eax
	rol	edi,		5
	lea	esi,		DWORD PTR 3395469782[ebp+esi]
	add	esi,		edi
	; 20_39 61
	mov	ebp,		eax
	...
	mov	edx,		esi
	rol	edx,		5
	lea	edi,		DWORD PTR 3395469782[ebp+edi]
	add	edi,		edx
	; 20_39 62
	mov	ebp,		esi
	...
	mov	ecx,		edi
	rol	ecx,		5
	lea	edx,		DWORD PTR 3395469782[ebp+edx]
	add	edx,		ecx
	; 20_39 63
	mov	ebp,		edi
	...
	mov	ebx,		edx
	rol	ebx,		5
	lea	ecx,		DWORD PTR 3395469782[ebp+ecx]
	add	ecx,		ebx
	; 20_39 64
	mov	ebp,		edx
	mov	ebx,		DWORD PTR [esp]
	...
	mov	eax,		ecx
	rol	eax,		5
	lea	ebx,		DWORD PTR 3395469782[ebp+ebx]
	add	ebx,		eax
	; 20_39 65
	mov	ebp,		ecx
	mov	eax,		DWORD PTR 4[esp]
	...
	mov	esi,		ebx
	rol	esi,		5
	lea	eax,		DWORD PTR 3395469782[ebp+eax]
	add	eax,		esi
	; 20_39 66
	mov	ebp,		ebx
	mov	esi,		DWORD PTR 8[esp]
