// cairotest.cpp : Defines the entry point for the console application.
//
...
TCHAR szTitle[MAX_LOADSTRING] = _T ("WinLauncher");                    // The title bar text
TCHAR szWindowClass[MAX_LOADSTRING] =  _T ("WINLAUNCHER");            // the main window class name
HDC dc;
HGLRC rc;
int LastUpdate = 0;
int Frames = 0;
...
#endif
{
    ...
    SetClientSize(hMainWnd, 256, 256);
